...
Once created, you need to **activate** the virtual environment before using it. Activation modifies your shell's PATH so that commands like `python` and `pip` point to the virtual environment's versions.
