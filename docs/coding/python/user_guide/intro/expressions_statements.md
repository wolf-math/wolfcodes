...
:::note
You'll learn more about expressions when you study [operators](../types_variables_conditionals/operators.md). For now, just know that expressions produce values.
:::
...
:::note
You'll see more examples of statements when you learn about [variables](../types_variables_conditionals/variables.md) and [conditionals](../types_variables_conditionals/conditionals.md). For now, just know that statements perform actions.
:::
...
This distinction will become clearer as you learn more about [operators](../types_variables_conditionals/operators.md) and other Python features. For now, just remember: expressions produce values, statements perform actions.
