...
Python evaluates conditions based on truthiness (which you learned about in the [truthiness guide](./truthiness.md)). This means you can use any value in a condition, not just `True` or `False`.
