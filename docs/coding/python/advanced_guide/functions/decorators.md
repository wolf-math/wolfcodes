...
---
This guide covers advanced decorator concepts and patterns. For fundamental decorator concepts, see the [user guide on decorators](../../user_guide/functions/decorators.md).
...
Understanding these advanced concepts helps you write more sophisticated decorators and debug decorator-related issues. For fundamental decorator concepts and common patterns, see the [user guide on decorators](../../user_guide/functions/decorators.md).
