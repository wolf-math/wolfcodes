...
Understanding these principles helps you use lambdas effectively. They're a tool for simple, inline functions. When complexity grows, let `def` take over. For basic lambda syntax and common patterns, see the [user guide on lambda functions](../../user_guide/functions/lambda.md).
